...
public abstract class AbstractMultiInstanceBodyHandler
  ...
  protected DirectBuffer readOutputElementVariable(
    ...
    return expressionProcessor.evaluateAnyExpression(expression, context).orElse(null);
  }
  ...
  protected void createInnerInstance(
    ...
    loopCharacteristics
        ...
        // TODO (@korthout/@saig0): filter out all non-variable expressions without this ugly regex
        .ifPresent(
            variableName ->
                variablesState.setVariableLocal(
                    elementInstanceKey,
